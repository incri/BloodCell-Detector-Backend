...
class BloodTestImageData(models.Model):
    blood_test = models.ForeignKey(BloodTest, on_delete=models.CASCADE, related_name='images')
    image = models.ImageField(upload_to='lab/data-images')


class ResultImageData(models.Model):
    result = models.ForeignKey(Result, on_delete=models.CASCADE, related_name='result_images')
