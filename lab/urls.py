...
blood_tests_router = routers.NestedDefaultRouter(router, 'blood-tests', lookup = 'blood_test')
patients_router = routers.NestedDefaultRouter(router, 'patients', lookup = 'patient')

blood_tests_router.register('results', views.ResultViewSet, basename='blood-test-results')
